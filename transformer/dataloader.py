...
def collate(batch_data):
    ...
    factorized_data = torch.nn.utils.rnn.pad_sequence(factorized_data)
    expanded_data = torch.nn.utils.rnn.pad_sequence(expanded_data)

    return factorized_data, expanded_data
